...
button:hover {
  ...
  <hr>
                ...
                <a style="font-family: ink free; margin-left: 1000px; text-decoration: none; color:black;" href="home.jsp">&nbsp;Go to Home</a>
...
//            ResultSet upicheck=s2.executeQuery("select * from bank_acc where ");
            ...
            if(res.next())
            {
                ...
                if(res1.next())
                {
                    String upipin=res1.getString("upi_pin");
                    if(upi.equals(upipin))
                    {
...
<!--        <script type="text/javascript">
                                    ...
                                    window.location = "check balance.jsp";
                                </script> -->
...
<div class="animate">
            ...
            <a href="check balance.jsp" style="color: red; text-decoration: none">OK</a>
            </center>
