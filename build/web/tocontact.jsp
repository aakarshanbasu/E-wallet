  ...
  <hr>
    ...
    <center>
        <form action="sendmoney.jsp" method="post">
            <input type="text" placeholder="Enter Mobile Number" name="mob_no" required><br>
            ...
            <button type="submit" style="background-color: white; border: 0px;"><i style="color: #2771d5; font-size: 50px;"class="fas fa-check"></i></button><br>
