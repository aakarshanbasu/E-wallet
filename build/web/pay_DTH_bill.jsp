    ...
    Class.forName("oracle.jdbc.OracleDriver");
            ...
            if(res1.next())
            {
                ...
                if(upi.equals(upis))
                {
                    ...
                    ResultSet res2=stm.executeQuery("select * from dth_provider where name='"+board+"'");
            if(res2.next())
            {
                int id=res2.getInt("id");
                ResultSet res3=stm.executeQuery("select * from dth_bill where acc_no='"+billacc+"' and id='"+id+"'");
                    if(res3.next())
                    {
...
//                            int reset=0;
                            ...
                            stm.executeQuery("delete from dth_bill where acc_no='"+billacc+"' and id='"+id+"'");
