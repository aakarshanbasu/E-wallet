    ...
    Class.forName("oracle.jdbc.OracleDriver");
            ...
            if(res1.next())
            {
                ...
                if(upi.equals(upis))
                {
                    ...
                    ResultSet res2=stm.executeQuery("select * from electricity_board where name='"+board+"'");
            if(res2.next())
            {
                int id=res2.getInt("id");
                ResultSet res3=stm.executeQuery("select * from electricity_bill where acc_no='"+billacc+"' and id='"+id+"'");
                    if(res3.next())
                    {
...
//                            int reset=0;
                            ...
                            stm.executeQuery("delete from electricity_bill where acc_no='"+billacc+"' and id='"+id+"'");
